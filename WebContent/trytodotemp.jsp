...
<body>
<h1 align="center">Salses Anaytics</h1>
...
ResultSet rs=null,rs_2=null,rs_3=null,rs_cate=null,rs_p=null, rs_cell=null, rs_temp=null;
// String SQL=null;
...
<form action="sales_analytics.jsp" method="POST">
		...
		<select name="state">
			...
			<% if(request.getParameter("state")!=null && ((String)(request.getParameter("state"))).equals("All States")){
				%>
